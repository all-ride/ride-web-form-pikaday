 ...
 * Date row
 */
class PikadayDateRow extends DateRow implements HtmlRow {
    ...
    public function getJavascripts() {
        return array('../js/moment.js', '../js/pikaday.js', '../js/pikaday.jquery.js', '../js/datepicker.js');
    }
